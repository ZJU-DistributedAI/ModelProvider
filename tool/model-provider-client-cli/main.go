...
func main() {
	...
	app := &cobra.Command{
		Use:   "Model Provider Client-cli",
		Short: `CLI client for the Model Provider Client service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "localhost:2626", "API hostname")
	...
	c.UserAgent = "Model Provider Client-cli/0"
